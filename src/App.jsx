...
function Shell({ user, logout }) {
  ...
  const visibleNav = useMemo(() => NAV.filter(([id]) => id === 'platform' ? user.platform_admin : ['iam', 'security'].includes(id) ? user.platform_admin : hasAccess(id)), [hasAccess, user.platform_admin])
